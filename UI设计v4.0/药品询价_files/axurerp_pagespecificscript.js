...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('搜索框_1.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('按疾病搜索.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('首页2（参保人）.html');
